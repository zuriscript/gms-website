...
const Footer: React.FC = () => (
  <Styled.Footer>
    ...
    <Styled.TextContainer> 
      ...
      <Styled.Text css={tw`pt-5 px-2 md:px-10 lg:px-4`}>GraphMineSuite is actively developed. As subject of research it will likely include more features in the future. If you are interested in our work contact us via SPCL.</Styled.Text>
